...
export class LoginAdmin extends React.Component {
    ...
    render(){
        ...
        return <form className='base-container' ref={this.props.containerRef}>
            <div className='header'>Login as admin</div>
            ...
            <div className='footer'>
                <button type='submit' className='btn' formAction='/admindash'>Login </button>
            </div>
        </form>
    }
}
